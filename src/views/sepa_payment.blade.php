        ...
        stripe.confirmSepaDebitPayment('{{ $data["client_secret"] }}', {
            ...
            if (result.error) {
                ...
                else if(status === 'processing' )
                {
                    ...
                    displaySuccess.textContent = "Die Zahlung ist noch in Bearbeitung, Sie werden informiert, ob sie erfolgreich war oder nicht.";

                    setTimeout(function()
                    {
                        window.location.href = ' /inbearbeitung/'+result.paymentIntent.client_secret;
