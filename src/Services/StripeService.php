...
class StripeService
{
    ...
    public function cardPaymentIntent($request_data,$amount, $total_cost):bool
    {
        ...
        try {
            // create a payment intent and get the client secret ID
...
//              'setup_future_usage' => 'off_session',
    ...
    /**
     * create the SEPA payment and generate a secret key for the client authentication
     * @param $request_data
     * @param $name
     * @param $email
     * @param $amount
    ...
    public function sepaPaymentIntent($request_data, $name, $email,$amount, $payment_method):bool
    {
        ...
        try {
            ...
            // create the customer in the stripe
